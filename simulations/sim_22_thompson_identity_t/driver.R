...
cat(sprintf("--- Simulation Run sim_22_thompson_identity_t (Job ID: %d, Sep: %.1f) ---\n", job_id, separation))
...
data_res <- generate_data_from_specification(generator_spec, n, seed = 2026 + job_id, noise = "t")
X <- data_res$X
