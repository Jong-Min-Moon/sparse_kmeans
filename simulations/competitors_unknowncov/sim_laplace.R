# ------------------------------------------------------------------
# sim_laplace.R
# Competitor Evaluation under Laplace Noise
# ------------------------------------------------------------------
library(foreach)
library(doParallel)
...
log_file <- file.path(log_dir, "sim_laplace.log")

cat(sprintf("Starting Laplace Simulation. Results will be saved in %s/\n", res_dir))
log_progress(log_file, sprintf("\n==========================================\n--- Laplace Simulation Started at %s ---\n==========================================\n", Sys.time()))
...
log_progress(log_file, sprintf("\n==========================================\n--- Laplace Simulation Completed at %s (Runtime: %.2f mins) ---\n==========================================\n", Sys.time(), overall_runtime))
