# ---------------------------------------------------------
# Single Simulation Run: Permutation FDR (Unknown Covariance, Target 0.4, Sep=4)
# ---------------------------------------------------------
library(methods)
library(MASS)
library(mclust)
...
# ---------------------------------------------------------
# MATCHING SIM07 SETTINGS but Sep=4:
# p=400, n=500, K=2, rho=0.45, separation=4, support=1:10
p <- 400
n <- 500
K <- 2
rho_param <- 45
