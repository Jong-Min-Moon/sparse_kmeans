<#
.SYNOPSIS
    Retrieves Simulation 08 results from the HPC cluster.
#>
...
param(
    ...
    [string]$LocalDir = "d:\GitHub\sparse_kmeans\simulations\sim08_permutation_fdr_sep4"
)

$ErrorActionPreference = "Stop"

$RemoteSimDir = "${RemoteBase}/simulations/sim08_permutation_fdr_sep4"
