...
<#
.SYNOPSIS
    Retrieves Simulation v3.1 Oracle ISEE results from the HPC cluster.
#>
...
$LocalDir = "d:\GitHub\sparse_kmeans\simulations\sim_v3_1_oracle_isee"
$RemoteSimDir = "${RemoteBase}/simulations/sim_v3_1_oracle_isee"
