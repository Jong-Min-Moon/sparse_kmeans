...
<#
.SYNOPSIS
    Deploys Simulation v3.1 (Oracle ISEE ALWAYS) to HPC.
#>
...
# Define Local Paths
$SimDir = "d:\GitHub\sparse_kmeans\simulations\sim_v3_1_oracle_isee"
...
SIMDIR=$RBASE/simulations/sim_v3_1_oracle_isee
...
$sbatchCmd = "cd ${resolvedBase}/simulations/sim_v3_1_oracle_isee && sbatch submit_v3_1.slurm"
