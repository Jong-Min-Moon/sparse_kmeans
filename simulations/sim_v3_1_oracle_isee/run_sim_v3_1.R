# ---------------------------------------------------------
# Single Simulation Run: Thompson Sampling v3.1 (Oracle ISEE ALWAYS)
# ---------------------------------------------------------
library(methods)
library(MASS)
library(mclust)
...
cat(sprintf("--- Simulation Run v3.1 (Job ID: %d) ---\n", job_id))
...
# ---------------------------------------------------------
# Run Algorithm (Thompson Sampling v3.1)
# ---------------------------------------------------------
cat("Running block_coordinate_optim_thompson_unknowncov_v3_1...\n")
...
start_time <- Sys.time()
res <- block_coordinate_optim_thompson_unknowncov_v3_1(
    X = X,
    K = 2,
    n_iter = 1000,
    C = C,
