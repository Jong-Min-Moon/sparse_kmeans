# ------------------------------------------------------------------
# aggregate_hpc.R
# Aggregates unified unknown-covariance simulation outputs from HPC.
...
for (noise in noise_types) {
    ...
    # Locate all generated outputs matching the expected dataset extension
    ...
    # accuracy_ifpca, ifpca_L, runtime_ifpca
