...
$LocalDir = "d:\GitHub\sparse_kmeans\simulations\production\sim_22_thompson_identity_laplace"
$RemoteDir = "${RemoteBase}/simulations/production/sim_22_thompson_identity_laplace/results_raw"
