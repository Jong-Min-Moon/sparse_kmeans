<#
.SYNOPSIS
    Deploys Greedy ISEE n500-Chain simulation to the HPC cluster.
#>
...
$SimName = "unknowncov_n500_chain_greedy_isee"
...
scp "${SimDir}\sim_laplace.R" "${SimDir}\sim_gaussian.R" "${SimDir}\submit.sh" `
