...
$LocalDir = "d:\GitHub\sparse_kmeans\simulations\production\sim_22_thompson_identity"
$RemoteDir = "${RemoteBase}/simulations/production/sim_22_thompson_identity/results_raw"
