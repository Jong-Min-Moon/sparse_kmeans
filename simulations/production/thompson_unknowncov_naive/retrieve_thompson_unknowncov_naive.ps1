...
# Using scp -r to pull the entire results_raw directory iteratively over p structure
...
Write-Host "Sync process complete. You can now execute aggregate_results.R locally." -ForegroundColor Green
