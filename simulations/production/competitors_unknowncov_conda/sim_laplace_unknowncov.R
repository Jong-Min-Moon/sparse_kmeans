...
cat(sprintf("Starting Laplace Unknown-Covariance Simulation. Results will be saved in %s/\n", res_dir))
log_progress(log_file, sprintf(
    "\n==========================================\n--- Laplace Unknown-Covariance Started at %s ---\n==========================================\n",
    Sys.time()
))
...
log_progress(log_file, sprintf(
    "\n==========================================\n--- Laplace Unknown-Cov Simulation Completed at %s (Runtime: %.2f mins) ---\n==========================================\n",
