...
$LocalDir = "d:\GitHub\sparse_kmeans\simulations\production\unknowncov_n200_chain_thompson"
$RemoteDir = "${RemoteBase}/simulations/production/unknowncov_n200_chain_thompson/results_raw"
