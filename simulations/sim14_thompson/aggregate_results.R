# ------------------------------------------------------------------
# aggregate_results.R
# Aggregates results_raw for sim14_thompson parameter grid
# ------------------------------------------------------------------
library(dplyr)
library(tidyr)
...
saveRDS(df, file = "results_aggregated/aggregated_sim14.rds")
write.csv(summary_df, file = "results_aggregated/summary_sim14.csv", row.names = FALSE)
