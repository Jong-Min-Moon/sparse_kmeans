# Aggregate Simulation 14 Results (Thompson Sampling)
...
summary_file <- "summary_sim14.csv"

if (!dir.exists(output_dir)) {
    stop("Output directory not found: ", output_dir, "\nRun retrieve_sim14.sh first.")
}
...
cat("\n=== Simulation 14 Summary ===\n")
print(summary_stats)

saveRDS(all_results, "all_results_sim14.rds")
