...
<#
.SYNOPSIS
    Retrieves Simulation 09 (First-Iter Oracle ISEE) results from the HPC cluster.
#>
...
$LocalDir = "d:\GitHub\sparse_kmeans\simulations\sim09_first_iter_true_ISEE"
$RemoteResultsDir = "${RemoteBase}/simulations/sim09_first_iter_true_ISEE/results"
