# Aggregate Simulation 09 Results (First-Iter Oracle ISEE, Permutation FDR 0.4)
# Companion to aggregate_sim07.R and aggregate_sim08.R.
...
summary_file <- "summary_sim09.csv"

if (!dir.exists(output_dir)) {
    stop("Output directory not found: ", output_dir, "\nRun retrieve_sim09.ps1 first.")
}
...
cat("\n=== Simulation 09 Summary (First-Iter Oracle ISEE) ===\n")
print(summary_stats)

saveRDS(all_results, "all_results_sim09.rds")
