...
<#
.SYNOPSIS
    Deploys Simulation 09 (First-Iter Oracle ISEE) to HPC.
#>
...
$SimDir = "d:\GitHub\sparse_kmeans\simulations\sim09_first_iter_true_ISEE"
$CodeDir = "d:\GitHub\sparse_kmeans\code_r"

# 1. Transfer files (code_r includes the new first-iter oracle ISEE algorithm)
...
SIMDIR=$RBASE/simulations/sim09_first_iter_true_ISEE
...
ssh "${Username}@${Hostname}" "cd ${resolvedBase}/simulations/sim09_first_iter_true_ISEE && sbatch submit.sh"
