# ------------------------------------------------------------------------------
# Script: aggregate_sim_laplace.R
# Purpose: Compiles, merges, and validates the output generated across isolated 
#          HPC computational nodes running `sim_laplace_thompson_identity`. 
...
summary_file <- "summary_sim_laplace.csv"

if (!dir.exists(output_dir)) {
    stop("Output directory not found: ", output_dir, "\nRun retrieve_sim_laplace.ps1 using Powershell first.")
}
...
saveRDS(all_results, "all_results_sim_laplace.rds")
