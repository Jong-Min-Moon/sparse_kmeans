# ---------------------------------------------------------
# Single Simulation Run: Unknown Covariance (Deterministic, n=200)
# ---------------------------------------------------------
library(methods)
library(MASS)
library(mclust)
...
# Source Code (Adjusted paths for simulations/sim05.../)
...
p <- 400
n <- 200 # Reduced sample size per user request
K <- 2
rho_param <- 45
rho <- rho_param / 100
separation <- 4
