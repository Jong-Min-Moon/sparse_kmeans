...
<#
.SYNOPSIS
    Retrieves Simulation 10 (First-Iter Oracle ISEE) results from the HPC cluster.
#>
...
$LocalDir = "d:\GitHub\sparse_kmeans\simulations\sim10_first_iter_oracle_ISEE"
$RemoteResultsDir = "${RemoteBase}/simulations/sim10_first_iter_oracle_ISEE/results"
