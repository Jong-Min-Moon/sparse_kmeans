# Aggregate Simulation 04 Results
...
summary_file <- "summary_sim04.csv"

if (!dir.exists(output_dir)) {
    stop("Output directory not found: ", output_dir, "\nRun retrieve_sim04.ps1 first to download results.")
}
...
saveRDS(all_results, "all_results_sim04.rds")
cat(sprintf("\nFull results saved to all_results_sim04.rds\n"))
