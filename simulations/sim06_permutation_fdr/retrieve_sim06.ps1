<#
.SYNOPSIS
    Retrieves Simulation 06 results from the HPC cluster.
#>
...
param(
    ...
    [string]$LocalDir = "d:\GitHub\sparse_kmeans\simulations\sim06_permutation_fdr"
)

$ErrorActionPreference = "Stop"

$RemoteSimDir = "${RemoteBase}/simulations/sim06_permutation_fdr"
