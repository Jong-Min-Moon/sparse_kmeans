...
for jj = 1:4
    ...
    [cluster_est_mat, diff_x_tilde, diff_omega_diag, entries_survived, omega_est_time, sdp_solve_time, obj]= iterative_kmeans_ISEE_denoise(x_noisy, K, n_iter, Omega, Omega_sparsity, 'spec');
    ...
    data = table(...
        ...
        ["rep", "iter", "sep", "dim", "rho", "sparsity", "acc", "obj", "discov_true", "discov_false", "diff_x_tilde", "diff_omega_diag",  "time_isee", "time_SDP", "jobdate"])
