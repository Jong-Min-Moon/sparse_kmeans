#!/bin/bash
#SBATCH --job-name=bandit_p2000_rep76 # Job name for easier identification in queue
#SBATCH --output="/home1/jongminm/sparse_kmeans/experiment/29_08_11_2025/bandit_thinning/bandit_thinning_sep4_p2000_rep_76.out"              # Standard output and error log file
...
echo "Starting job for p=2000, rep=76 on $(hostname) at $(date)"
...
matlab -batch "bandit_thinning_sep4_p2000_rep_76"

# Echo end time for logging
echo "Finished job for p=2000, rep=76 at $(date)"
