#!/bin/bash
#SBATCH --job-name=bandit_p1000_rep18 # Job name for easier identification in queue
#SBATCH --output="/home1/jongminm/sparse_kmeans/experiment/29_08_11_2025/bandit_thinning/bandit_thinning_sep5_p1000_rep_18.out"              # Standard output and error log file
...
matlab -batch "bandit_thinning_sep5_p1000_rep_18"
