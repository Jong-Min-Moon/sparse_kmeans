#!/bin/bash
#SBATCH --job-name=bandit_p3000_rep53 # Job name for easier identification in queue
#SBATCH --output="/home1/jongminm/sparse_kmeans/experiment/29_08_11_2025/bandit_thinning/bandit_thinning_sep4_p3000_rep_53.out"              # Standard output and error log file
...
echo "Starting job for p=3000, rep=53 on $(hostname) at $(date)"
...
matlab -batch "bandit_thinning_sep4_p3000_rep_53"

# Echo end time for logging
echo "Finished job for p=3000, rep=53 at $(date)"
