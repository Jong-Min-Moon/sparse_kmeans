...
#SBATCH --output="/home1/jongminm/sparse_kmeans/experiment/29_08_11_2025/bandit_thinning/bandit_thinning_sep4_p2000_rep_57.out"              # Standard output and error log file
...
matlab -batch "bandit_thinning_sep4_p2000_rep_57"
