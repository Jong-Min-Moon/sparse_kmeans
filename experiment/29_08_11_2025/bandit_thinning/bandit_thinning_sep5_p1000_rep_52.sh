#!/bin/bash
#SBATCH --job-name=bandit_p1000_rep52 # Job name for easier identification in queue
#SBATCH --output="/home1/jongminm/sparse_kmeans/experiment/29_08_11_2025/bandit_thinning/bandit_thinning_sep5_p1000_rep_52.out"              # Standard output and error log file
...
echo "Starting job for p=1000, rep=52 on $(hostname) at $(date)"
...
matlab -batch "bandit_thinning_sep5_p1000_rep_52"

# Echo end time for logging
echo "Finished job for p=1000, rep=52 at $(date)"
