#!/bin/bash
#SBATCH --job-name=bandit_p3000_rep82 # Job name for easier identification in queue
#SBATCH --output="/home1/jongminm/sparse_kmeans/experiment/29_08_11_2025/bandit_thinning/bandit_thinning_sep4_p3000_rep_82.out"              # Standard output and error log file
...
echo "Starting job for p=3000, rep=82 on $(hostname) at $(date)"
...
matlab -batch "bandit_thinning_sep4_p3000_rep_82"

# Echo end time for logging
echo "Finished job for p=3000, rep=82 at $(date)"
