#!/bin/bash
#SBATCH --job-name=bandit_p5000_rep93 # Job name for easier identification in queue
#SBATCH --output="/home1/jongminm/sparse_kmeans/experiment/29_08_11_2025/bandit_thinning/bandit_thinning_sep4_p5000_rep_93.out"              # Standard output and error log file
...
echo "Starting job for p=5000, rep=93 on $(hostname) at $(date)"
...
matlab -batch "bandit_thinning_sep4_p5000_rep_93"

# Echo end time for logging
echo "Finished job for p=5000, rep=93 at $(date)"
