...
#SBATCH --output="/home1/jongminm/sparse_kmeans/experiment/29_08_11_2025/bandit_thinning/bandit_thinning_sep5_p3000_rep_10.out"              # Standard output and error log file
...
matlab -batch "bandit_thinning_sep5_p3000_rep_10"
