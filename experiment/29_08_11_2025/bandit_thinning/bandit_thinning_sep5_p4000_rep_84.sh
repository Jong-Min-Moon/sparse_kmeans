#!/bin/bash
#SBATCH --job-name=bandit_p4000_rep84 # Job name for easier identification in queue
#SBATCH --output="/home1/jongminm/sparse_kmeans/experiment/29_08_11_2025/bandit_thinning/bandit_thinning_sep5_p4000_rep_84.out"              # Standard output and error log file
...
echo "Starting job for p=4000, rep=84 on $(hostname) at $(date)"
...
matlab -batch "bandit_thinning_sep5_p4000_rep_84"

# Echo end time for logging
echo "Finished job for p=4000, rep=84 at $(date)"
