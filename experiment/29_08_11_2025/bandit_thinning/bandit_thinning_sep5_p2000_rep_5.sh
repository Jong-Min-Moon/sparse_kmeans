#!/bin/bash
#SBATCH --job-name=bandit_p2000_rep5 # Job name for easier identification in queue
#SBATCH --output="/home1/jongminm/sparse_kmeans/experiment/29_08_11_2025/bandit_thinning/bandit_thinning_sep5_p2000_rep_5.out"              # Standard output and error log file
...
matlab -batch "bandit_thinning_sep5_p2000_rep_5"
