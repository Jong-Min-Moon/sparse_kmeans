#!/bin/bash
#SBATCH --job-name=bandit_p5000_rep2 # Job name for easier identification in queue
#SBATCH --output="/home1/jongminm/sparse_kmeans/experiment/29_08_11_2025/bandit_thinning/bandit_thinning_sep4_p5000_rep_2.out"              # Standard output and error log file
...
matlab -batch "bandit_thinning_sep4_p5000_rep_2"
