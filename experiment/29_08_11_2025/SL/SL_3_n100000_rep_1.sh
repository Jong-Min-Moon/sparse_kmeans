#!/bin/bash
#SBATCH --job-name=SL_p10000_rep1 # Job name for easier identification in queue
#SBATCH --output="/home1/jongminm/sparse_kmeans/experiment/29_08_11_2025/SL/SL_3_n100000_rep_1.out"              # Standard output and error log file
...
matlab -batch "SL_3_n100000_rep_1"
