#!/bin/bash
#SBATCH --job-name=SL_p10000_rep41 # Job name for easier identification in queue
#SBATCH --output="/home1/jongminm/sparse_kmeans/experiment/29_08_11_2025/SL/SL_4_n80000_rep_41.out"              # Standard output and error log file
...
matlab -batch "SL_4_n80000_rep_41"
