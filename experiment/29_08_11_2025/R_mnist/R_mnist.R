...
x_full <- read.csv("/home1/jongminm/sparse_kmeans/experiment/29_08_11_2025/R_mnist/selected_data.csv")
y_full <- read.csv("/home1/jongminm/sparse_kmeans/experiment/29_08_11_2025/R_mnist/selected_labels.csv")
...
time_arias_sum = 0
    ...
    data = get_proportional_subsample(x_full, y_full, 20, 2)
