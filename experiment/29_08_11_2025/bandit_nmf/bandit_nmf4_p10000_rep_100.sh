...
#SBATCH --output="/home1/jongminm/sparse_kmeans/experiment/29_08_11_2025/bandit_nmf/bandit_nmf4_p10000_rep_100.out"              # Standard output and error log file
...
cd "/home1/jongminm/sparse_kmeans/experiment/29_08_11_2025/bandit_nmf" || { echo "Error: Could not change to directory /home1/jongminm/sparse_kmeans/experiment/29_08_11_2025/bandit_nmf. Exiting."; exit 1; }

# Run the MATLAB script in batch mode
# The -batch option runs the specified script and then exits MATLAB
matlab -batch "bandit_nmf4_p10000_rep_100"
