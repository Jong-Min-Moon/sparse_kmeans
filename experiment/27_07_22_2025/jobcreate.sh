...
BASE_DIR="/home1/jongminm/sparse_kmeans/experiment/27_07_22_2025/bandit_even"
...
for REP in $(seq 1 200); do
    ...
    for P in 1000 2000 3000 4000 5000 6000 7000 8000 9000 10000; do
        ...
        MFILE_NAME="bandit_even_sep${SEP}_p${P}_rep_${REP}" # Name without .m extension
...
% Parameters for this simulation run:
   p = ${P} (number of features/dimensions)
   rep = ${REP} (repetition number)
...
[data, label_true, mu1, mu2, generated_sep, ~, beta_star] = generate_gaussian_data(n, p, sep, model, rep, cluster_1_ratio);
...
bandit.fit_predict(500, label_true);
