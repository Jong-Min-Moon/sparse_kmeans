...
BASE_DIR="/home1/jongminm/sparse_kmeans/experiment/27_07_22_2025/bandit_diff"
# Path to the SQLite database
DB_DIR="/home1/jongminm/sparse_kmeans/sparse_kmeans.db"
# Table name within the SQLite database
TABLE_NAME="bandit_diff"
...
for REP in $(seq 1 100); do
    ...
    for P in  6000 7000 8000 9000 10000; do

        # Define filenames based on current parameters
        MFILE_NAME="bandit_diff_sep${SEP}_p${P}_rep_${REP}" # Name without .m extension
...
bandit = sdp_kmeans_bandit_simul(data, 2);
