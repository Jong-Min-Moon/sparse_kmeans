function run_bandit_task(task_id, param_file, results_dir)
    ...
    % Run simulation
    [data, label_true] = generate_gaussian_data(200, p_val, 10, 4, 'iso', 'equal_symmetric', 0, rep, 0.5, rep);
    bandit = sdp_kmeans_bandit_simul(data', 2, C_val);
    bandit.fit_predict(20, label_true');
    
    % Save result to individual .mat file
    bandit.save_results(results_dir, rep, 4, 1:10);
end