#!/bin/bash
#SBATCH --job-name=nmfsl_p3000_rep13 # Job name for easier identification in queue
#SBATCH --output="/home1/jongminm/sparse_kmeans/experiment/30_08_15_2025/nmfsl/nmfsl_4_p3000_rep_13.out"              # Standard output and error log file
...
matlab -batch "nmfsl_4_p3000_rep_13"
