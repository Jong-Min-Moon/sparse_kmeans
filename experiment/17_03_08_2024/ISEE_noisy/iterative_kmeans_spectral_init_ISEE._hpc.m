function [cluster_est, diff_x_tilde, diff_omega_diag, entries_survived, omega_est_time, sdp_solve_time] = iterative_kmeans_spectral_init_ISEE(x, K, n_iter, init_method) 
    ...
    for iter = 1:n_iter
        ...
        cluster_est_now = sdp_to_cluster(Z_now);
