...
n_rep = 100;
clustering_acc_mat_5000 = zeros(n_rep, length(s_vec));
...
for i = 1:length(s_vec)
    ...
    for j = 1:n_rep
        ...
        clustering_acc_mat_5000(j,i) = iterative_kmeans_spectral_init_ver_01_19_24(x_noisy, sigma, K, n_iter, rounding, cluster_true);
    end
    toc
end

csvwrite('spectral_init_p_5000_s_trend_1.csv',clustering_acc_mat_5000)