...
for s in "${s_list[@]}"; do
  for ratio in "${cluster_1_ratio_list[@]}"; do
    for id in {1..6}; do
      ...
      script_name="/home1/jongminm/sparse_kmeans/experiment/26_04_24_2025/objective_plot_baseline_0_pen_largesep/job_s${s}_r${ratio}_v${id}.slurm"

cat <<EOF > "$script_name"
#!/bin/bash
#SBATCH --job-name=s${s}_r${ratio}_v${id}
#SBATCH --output=/home1/jongminm/sparse_kmeans/experiment/26_04_24_2025/objective_plot_baseline_0_pen_largesep/s${s}_r${ratio}_v${id}.out
#SBATCH --error=/home1/jongminm/sparse_kmeans/experiment/26_04_24_2025/objective_plot_baseline_0_pen_largesep/s${s}_r${ratio}_v${id}.err
