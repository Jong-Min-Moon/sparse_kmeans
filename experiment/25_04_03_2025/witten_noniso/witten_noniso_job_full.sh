...
experiment_name="witten_noniso"
extension_code="R"
table_name="noniso_witten"
    ...
    for separation in 3 4
        ...
        for dimension in  50 100 150 200 250 300 350 400 
            ...
            for ii in {1..10}
                do
                    #filename of code
                    filename_code="noniso_witten_rho${rho}_Delta${separation}_p${dimension}_rep_${ii}"
                    ...
                    ## method-specific skeleton code
                        cat ${code_dir}/witten_code_noniso.${extension_code} >> ${code_dir}/temp_code
