#!/bin/bash
#SBATCH --job-name=approx_sparse_mean_005_p2000_rep12 # Job name for easier identification in queue
#SBATCH --output="/home1/jongminm/sparse_kmeans/experiment/28_07_30_2025/approx_sparse_mean_005/approx_sparse_mean_005_4_p2000_rep_12.out"              # Standard output and error log file
...
echo "Starting job for p=2000, rep=12 on $(hostname) at $(date)"
...
matlab -batch "approx_sparse_mean_005_4_p2000_rep_12"

# Echo end time for logging
echo "Finished job for p=2000, rep=12 at $(date)"
