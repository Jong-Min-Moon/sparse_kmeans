#!/bin/bash
#SBATCH --job-name=approx_sparse_mean_005_p3000_rep50 # Job name for easier identification in queue
#SBATCH --output="/home1/jongminm/sparse_kmeans/experiment/28_07_30_2025/approx_sparse_mean_005/approx_sparse_mean_005_4_p3000_rep_50.out"              # Standard output and error log file
...
echo "Starting job for p=3000, rep=50 on $(hostname) at $(date)"
...
matlab -batch "approx_sparse_mean_005_4_p3000_rep_50"

# Echo end time for logging
echo "Finished job for p=3000, rep=50 at $(date)"
