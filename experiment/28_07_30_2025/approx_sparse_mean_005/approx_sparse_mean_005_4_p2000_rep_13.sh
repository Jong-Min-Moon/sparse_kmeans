#!/bin/bash
#SBATCH --job-name=approx_sparse_mean_005_p2000_rep13 # Job name for easier identification in queue
#SBATCH --output="/home1/jongminm/sparse_kmeans/experiment/28_07_30_2025/approx_sparse_mean_005/approx_sparse_mean_005_4_p2000_rep_13.out"              # Standard output and error log file
...
matlab -batch "approx_sparse_mean_005_4_p2000_rep_13"
