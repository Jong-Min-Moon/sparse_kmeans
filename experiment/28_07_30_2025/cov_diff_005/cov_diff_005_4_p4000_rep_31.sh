#!/bin/bash
#SBATCH --job-name=cov_diff_005_p4000_rep31 # Job name for easier identification in queue
#SBATCH --output="/home1/jongminm/sparse_kmeans/experiment/28_07_30_2025/cov_diff_005/cov_diff_005_4_p4000_rep_31.out"              # Standard output and error log file
...
matlab -batch "cov_diff_005_4_p4000_rep_31"
