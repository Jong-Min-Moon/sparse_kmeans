#!/bin/bash
#SBATCH --job-name=cov_diff_005_p5000_rep13 # Job name for easier identification in queue
#SBATCH --output="/home1/jongminm/sparse_kmeans/experiment/28_07_30_2025/cov_diff_005/cov_diff_005_4_p5000_rep_13.out"              # Standard output and error log file
...
matlab -batch "cov_diff_005_4_p5000_rep_13"
