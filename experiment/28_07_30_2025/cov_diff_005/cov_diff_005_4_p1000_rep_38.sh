#!/bin/bash
#SBATCH --job-name=cov_diff_005_p1000_rep38 # Job name for easier identification in queue
#SBATCH --output="/home1/jongminm/sparse_kmeans/experiment/28_07_30_2025/cov_diff_005/cov_diff_005_4_p1000_rep_38.out"              # Standard output and error log file
...
cd "/home1/jongminm/sparse_kmeans/experiment/28_07_30_2025/cov_diff_005" || { echo "Error: Could not change to directory /home1/jongminm/sparse_kmeans/experiment/28_07_30_2025/cov_diff_005. Exiting."; exit 1; }

# Run the MATLAB script in batch mode
# The -batch option runs the specified script and then exits MATLAB
matlab -batch "cov_diff_005_4_p1000_rep_38"
