#!/bin/bash
#SBATCH --output="/home1/jongminm/sparse_kmeans/experiment/28_07_30_2025/approx_sparse_prec_001/approx_sparse_prec_001_rep_148_p400.out"
...
matlab -batch approx_sparse_prec_001_rep_148_p400
