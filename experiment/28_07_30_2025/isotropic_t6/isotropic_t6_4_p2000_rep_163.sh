#!/bin/bash
#SBATCH --job-name=isotropic_t6_p2000_rep163 # Job name for easier identification in queue
#SBATCH --output="/home1/jongminm/sparse_kmeans/experiment/28_07_30_2025/isotropic_t6/isotropic_t6_4_p2000_rep_163.out"              # Standard output and error log file
...
matlab -batch "isotropic_t6_4_p2000_rep_163"
