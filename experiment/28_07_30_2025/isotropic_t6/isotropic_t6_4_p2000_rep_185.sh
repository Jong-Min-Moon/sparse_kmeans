#!/bin/bash
#SBATCH --job-name=isotropic_t6_p2000_rep185 # Job name for easier identification in queue
#SBATCH --output="/home1/jongminm/sparse_kmeans/experiment/28_07_30_2025/isotropic_t6/isotropic_t6_4_p2000_rep_185.out"              # Standard output and error log file
...
cd "/home1/jongminm/sparse_kmeans/experiment/28_07_30_2025/isotropic_t6" || { echo "Error: Could not change to directory /home1/jongminm/sparse_kmeans/experiment/28_07_30_2025/isotropic_t6. Exiting."; exit 1; }

# Run the MATLAB script in batch mode
# The -batch option runs the specified script and then exits MATLAB
matlab -batch "isotropic_t6_4_p2000_rep_185"
