#!/bin/bash
#SBATCH --job-name=isotropic_t6_p1000_rep156 # Job name for easier identification in queue
#SBATCH --output="/home1/jongminm/sparse_kmeans/experiment/28_07_30_2025/isotropic_t6/isotropic_t6_4_p1000_rep_156.out"              # Standard output and error log file
...
matlab -batch "isotropic_t6_4_p1000_rep_156"
