#!/bin/bash
#SBATCH --job-name=cov_diff_01_p1000_rep34 # Job name for easier identification in queue
#SBATCH --output="/home1/jongminm/sparse_kmeans/experiment/28_07_30_2025/cov_diff_01/cov_diff_01_4_p1000_rep_34.out"              # Standard output and error log file
...
matlab -batch "cov_diff_01_4_p1000_rep_34"
