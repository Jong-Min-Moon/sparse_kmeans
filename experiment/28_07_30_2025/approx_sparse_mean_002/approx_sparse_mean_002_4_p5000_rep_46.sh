#!/bin/bash
#SBATCH --job-name=approx_sparse_mean_002_p5000_rep46 # Job name for easier identification in queue
#SBATCH --output="/home1/jongminm/sparse_kmeans/experiment/28_07_30_2025/approx_sparse_mean_002/approx_sparse_mean_002_4_p5000_rep_46.out"              # Standard output and error log file
...
echo "Starting job for p=5000, rep=46 on $(hostname) at $(date)"
...
matlab -batch "approx_sparse_mean_002_4_p5000_rep_46"

# Echo end time for logging
echo "Finished job for p=5000, rep=46 at $(date)"
