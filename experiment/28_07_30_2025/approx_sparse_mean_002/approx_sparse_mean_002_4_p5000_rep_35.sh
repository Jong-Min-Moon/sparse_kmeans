#!/bin/bash
#SBATCH --job-name=approx_sparse_mean_002_p5000_rep35 # Job name for easier identification in queue
#SBATCH --output="/home1/jongminm/sparse_kmeans/experiment/28_07_30_2025/approx_sparse_mean_002/approx_sparse_mean_002_4_p5000_rep_35.out"              # Standard output and error log file
...
matlab -batch "approx_sparse_mean_002_4_p5000_rep_35"
