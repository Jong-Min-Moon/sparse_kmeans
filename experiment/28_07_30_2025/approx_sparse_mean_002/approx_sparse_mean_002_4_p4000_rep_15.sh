#!/bin/bash
#SBATCH --job-name=approx_sparse_mean_002_p4000_rep15 # Job name for easier identification in queue
#SBATCH --output="/home1/jongminm/sparse_kmeans/experiment/28_07_30_2025/approx_sparse_mean_002/approx_sparse_mean_002_4_p4000_rep_15.out"              # Standard output and error log file
...
echo "Starting job for p=4000, rep=15 on $(hostname) at $(date)"
...
matlab -batch "approx_sparse_mean_002_4_p4000_rep_15"

# Echo end time for logging
echo "Finished job for p=4000, rep=15 at $(date)"
