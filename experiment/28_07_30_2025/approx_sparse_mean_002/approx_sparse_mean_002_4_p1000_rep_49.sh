#!/bin/bash
#SBATCH --job-name=approx_sparse_mean_002_p1000_rep49 # Job name for easier identification in queue
#SBATCH --output="/home1/jongminm/sparse_kmeans/experiment/28_07_30_2025/approx_sparse_mean_002/approx_sparse_mean_002_4_p1000_rep_49.out"              # Standard output and error log file
...
echo "Starting job for p=1000, rep=49 on $(hostname) at $(date)"
...
matlab -batch "approx_sparse_mean_002_4_p1000_rep_49"

# Echo end time for logging
echo "Finished job for p=1000, rep=49 at $(date)"
