#!/bin/bash
#SBATCH --job-name=approx_sparse_mean_002_p5000_rep20 # Job name for easier identification in queue
#SBATCH --output="/home1/jongminm/sparse_kmeans/experiment/28_07_30_2025/approx_sparse_mean_002/approx_sparse_mean_002_4_p5000_rep_20.out"              # Standard output and error log file
...
echo "Starting job for p=5000, rep=20 on $(hostname) at $(date)"
...
cd "/home1/jongminm/sparse_kmeans/experiment/28_07_30_2025/approx_sparse_mean_002" || { echo "Error: Could not change to directory /home1/jongminm/sparse_kmeans/experiment/28_07_30_2025/approx_sparse_mean_002. Exiting."; exit 1; }

# Run the MATLAB script in batch mode
# The -batch option runs the specified script and then exits MATLAB
matlab -batch "approx_sparse_mean_002_4_p5000_rep_20"

# Echo end time for logging
echo "Finished job for p=5000, rep=20 at $(date)"
