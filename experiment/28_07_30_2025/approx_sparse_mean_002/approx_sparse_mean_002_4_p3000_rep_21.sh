#!/bin/bash
#SBATCH --job-name=approx_sparse_mean_002_p3000_rep21 # Job name for easier identification in queue
#SBATCH --output="/home1/jongminm/sparse_kmeans/experiment/28_07_30_2025/approx_sparse_mean_002/approx_sparse_mean_002_4_p3000_rep_21.out"              # Standard output and error log file
...
matlab -batch "approx_sparse_mean_002_4_p3000_rep_21"
