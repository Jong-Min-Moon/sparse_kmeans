#!/bin/bash
#SBATCH --job-name=nmf_p10000_rep19 # Job name for easier identification in queue
#SBATCH --output="/home1/jongminm/sparse_kmeans/experiment/28_07_30_2025/nmf/nmf_3_n10000_rep_19.out"              # Standard output and error log file
...
matlab -batch "nmf_3_n10000_rep_19"
