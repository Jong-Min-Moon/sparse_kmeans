#!/bin/bash
#SBATCH --output="/home1/jongminm/sparse_kmeans/experiment/28_07_30_2025/approx_sparse_prec_002/approx_sparse_prec_002_rep_80_p100.out"
...
matlab -batch approx_sparse_prec_002_rep_80_p100
