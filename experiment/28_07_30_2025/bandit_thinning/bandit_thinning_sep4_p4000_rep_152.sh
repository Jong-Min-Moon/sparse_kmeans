#!/bin/bash
#SBATCH --job-name=bandit_p4000_rep152 # Job name for easier identification in queue
#SBATCH --output="/home1/jongminm/sparse_kmeans/experiment/28_07_30_2025/bandit_thinning/bandit_thinning_sep4_p4000_rep_152.out"              # Standard output and error log file
...
echo "Starting job for p=4000, rep=152 on $(hostname) at $(date)"
...
matlab -batch "bandit_thinning_sep4_p4000_rep_152"

# Echo end time for logging
echo "Finished job for p=4000, rep=152 at $(date)"
