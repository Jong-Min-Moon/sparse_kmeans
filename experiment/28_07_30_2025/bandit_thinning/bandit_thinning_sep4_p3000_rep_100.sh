#!/bin/bash
#SBATCH --job-name=bandit_p3000_rep100 # Job name for easier identification in queue
#SBATCH --output="/home1/jongminm/sparse_kmeans/experiment/28_07_30_2025/bandit_thinning/bandit_thinning_sep4_p3000_rep_100.out"              # Standard output and error log file
...
echo "Starting job for p=3000, rep=100 on $(hostname) at $(date)"
...
matlab -batch "bandit_thinning_sep4_p3000_rep_100"

# Echo end time for logging
echo "Finished job for p=3000, rep=100 at $(date)"
