#!/bin/bash
#SBATCH --job-name=bandit_p5000_rep172 # Job name for easier identification in queue
#SBATCH --output="/home1/jongminm/sparse_kmeans/experiment/28_07_30_2025/bandit_thinning/bandit_thinning_sep4_p5000_rep_172.out"              # Standard output and error log file
...
echo "Starting job for p=5000, rep=172 on $(hostname) at $(date)"
...
matlab -batch "bandit_thinning_sep4_p5000_rep_172"

# Echo end time for logging
echo "Finished job for p=5000, rep=172 at $(date)"
