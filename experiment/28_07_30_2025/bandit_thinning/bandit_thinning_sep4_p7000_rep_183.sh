#!/bin/bash
#SBATCH --job-name=bandit_p7000_rep183 # Job name for easier identification in queue
#SBATCH --output="/home1/jongminm/sparse_kmeans/experiment/28_07_30_2025/bandit_thinning/bandit_thinning_sep4_p7000_rep_183.out"              # Standard output and error log file
...
echo "Starting job for p=7000, rep=183 on $(hostname) at $(date)"
...
matlab -batch "bandit_thinning_sep4_p7000_rep_183"

# Echo end time for logging
echo "Finished job for p=7000, rep=183 at $(date)"
