#!/bin/bash
#SBATCH --job-name=bandit_p6000_rep131 # Job name for easier identification in queue
#SBATCH --output="/home1/jongminm/sparse_kmeans/experiment/28_07_30_2025/bandit_thinning/bandit_thinning_sep4_p6000_rep_131.out"              # Standard output and error log file
...
echo "Starting job for p=6000, rep=131 on $(hostname) at $(date)"
...
matlab -batch "bandit_thinning_sep4_p6000_rep_131"

# Echo end time for logging
echo "Finished job for p=6000, rep=131 at $(date)"
