#!/bin/bash
#SBATCH --job-name=bandit_p1000_rep187 # Job name for easier identification in queue
#SBATCH --output="/home1/jongminm/sparse_kmeans/experiment/28_07_30_2025/bandit_thinning/bandit_thinning_sep4_p1000_rep_187.out"              # Standard output and error log file
...
echo "Starting job for p=1000, rep=187 on $(hostname) at $(date)"
...
matlab -batch "bandit_thinning_sep4_p1000_rep_187"

# Echo end time for logging
echo "Finished job for p=1000, rep=187 at $(date)"
