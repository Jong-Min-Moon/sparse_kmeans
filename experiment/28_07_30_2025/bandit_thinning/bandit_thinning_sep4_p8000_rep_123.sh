#!/bin/bash
#SBATCH --job-name=bandit_p8000_rep123 # Job name for easier identification in queue
#SBATCH --output="/home1/jongminm/sparse_kmeans/experiment/28_07_30_2025/bandit_thinning/bandit_thinning_sep4_p8000_rep_123.out"              # Standard output and error log file
...
echo "Starting job for p=8000, rep=123 on $(hostname) at $(date)"
...
matlab -batch "bandit_thinning_sep4_p8000_rep_123"

# Echo end time for logging
echo "Finished job for p=8000, rep=123 at $(date)"
