#!/bin/bash
#SBATCH --job-name=bandit_p4000_rep7 # Job name for easier identification in queue
#SBATCH --output="/home1/jongminm/sparse_kmeans/experiment/28_07_30_2025/bandit_thinning/bandit_thinning_sep4_p4000_rep_7.out"              # Standard output and error log file
...
matlab -batch "bandit_thinning_sep4_p4000_rep_7"
