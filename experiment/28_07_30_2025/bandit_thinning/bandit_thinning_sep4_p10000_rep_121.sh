#!/bin/bash
#SBATCH --job-name=bandit_p10000_rep121 # Job name for easier identification in queue
#SBATCH --output="/home1/jongminm/sparse_kmeans/experiment/28_07_30_2025/bandit_thinning/bandit_thinning_sep4_p10000_rep_121.out"              # Standard output and error log file
...
echo "Starting job for p=10000, rep=121 on $(hostname) at $(date)"
...
cd "/home1/jongminm/sparse_kmeans/experiment/28_07_30_2025/bandit_thinning" || { echo "Error: Could not change to directory /home1/jongminm/sparse_kmeans/experiment/28_07_30_2025/bandit_thinning. Exiting."; exit 1; }

# Run the MATLAB script in batch mode
# The -batch option runs the specified script and then exits MATLAB
matlab -batch "bandit_thinning_sep4_p10000_rep_121"

# Echo end time for logging
echo "Finished job for p=10000, rep=121 at $(date)"
