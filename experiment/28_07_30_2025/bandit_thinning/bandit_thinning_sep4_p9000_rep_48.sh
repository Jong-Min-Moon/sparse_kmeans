#!/bin/bash
#SBATCH --job-name=bandit_p9000_rep48 # Job name for easier identification in queue
#SBATCH --output="/home1/jongminm/sparse_kmeans/experiment/28_07_30_2025/bandit_thinning/bandit_thinning_sep4_p9000_rep_48.out"              # Standard output and error log file
...
echo "Starting job for p=9000, rep=48 on $(hostname) at $(date)"
...
matlab -batch "bandit_thinning_sep4_p9000_rep_48"

# Echo end time for logging
echo "Finished job for p=9000, rep=48 at $(date)"
