#!/bin/bash
#SBATCH --job-name=bandit_p10000_rep8 # Job name for easier identification in queue
#SBATCH --output="/home1/jongminm/sparse_kmeans/experiment/28_07_30_2025/bandit_thinning/bandit_thinning_sep4_p10000_rep_8.out"              # Standard output and error log file
...
echo "Starting job for p=10000, rep=8 on $(hostname) at $(date)"
...
matlab -batch "bandit_thinning_sep4_p10000_rep_8"

# Echo end time for logging
echo "Finished job for p=10000, rep=8 at $(date)"
