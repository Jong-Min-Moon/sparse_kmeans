#!/bin/bash
#SBATCH --job-name=bandit_p2000_rep158 # Job name for easier identification in queue
#SBATCH --output="/home1/jongminm/sparse_kmeans/experiment/28_07_30_2025/bandit_thinning/bandit_thinning_sep4_p2000_rep_158.out"              # Standard output and error log file
...
echo "Starting job for p=2000, rep=158 on $(hostname) at $(date)"
...
matlab -batch "bandit_thinning_sep4_p2000_rep_158"

# Echo end time for logging
echo "Finished job for p=2000, rep=158 at $(date)"
