#!/bin/bash
#SBATCH --job-name=bandit_p1000_rep5 # Job name for easier identification in queue
#SBATCH --output="/home1/jongminm/sparse_kmeans/experiment/28_07_30_2025/bandit_thinning/bandit_thinning_sep4_p1000_rep_5.out"              # Standard output and error log file
...
matlab -batch "bandit_thinning_sep4_p1000_rep_5"
