#!/bin/bash
#SBATCH --output="/home1/jongminm/sparse_kmeans/experiment/28_07_30_2025/noniso_cov_diff_01/noniso_cov_diff_01_rep_43_p100.out"
...
matlab -batch noniso_cov_diff_01_rep_43_p100
