#!/bin/bash
#SBATCH --job-name=bandit_p16000_rep81 # Job name for easier identification in queue
#SBATCH --output="/home1/jongminm/sparse_kmeans/experiment/28_07_30_2025/bandit_spectral/bandit_spectral_sep4_p16000_rep_81.out"              # Standard output and error log file
...
echo "Starting job for p=16000, rep=81 on $(hostname) at $(date)"
...
matlab -batch "bandit_spectral_sep4_p16000_rep_81"

# Echo end time for logging
echo "Finished job for p=16000, rep=81 at $(date)"
