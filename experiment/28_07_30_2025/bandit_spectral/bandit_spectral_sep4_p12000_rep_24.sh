#!/bin/bash
#SBATCH --job-name=bandit_p12000_rep24 # Job name for easier identification in queue
#SBATCH --output="/home1/jongminm/sparse_kmeans/experiment/28_07_30_2025/bandit_spectral/bandit_spectral_sep4_p12000_rep_24.out"              # Standard output and error log file
...
echo "Starting job for p=12000, rep=24 on $(hostname) at $(date)"
...
matlab -batch "bandit_spectral_sep4_p12000_rep_24"

# Echo end time for logging
echo "Finished job for p=12000, rep=24 at $(date)"
