#!/bin/bash
#SBATCH --job-name=bandit_p12000_rep39 # Job name for easier identification in queue
#SBATCH --output="/home1/jongminm/sparse_kmeans/experiment/28_07_30_2025/bandit_spectral/bandit_spectral_sep4_p12000_rep_39.out"              # Standard output and error log file
...
echo "Starting job for p=12000, rep=39 on $(hostname) at $(date)"
...
matlab -batch "bandit_spectral_sep4_p12000_rep_39"

# Echo end time for logging
echo "Finished job for p=12000, rep=39 at $(date)"
