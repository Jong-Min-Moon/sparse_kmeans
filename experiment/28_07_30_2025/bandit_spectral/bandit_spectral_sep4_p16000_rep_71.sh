#!/bin/bash
#SBATCH --job-name=bandit_p16000_rep71 # Job name for easier identification in queue
#SBATCH --output="/home1/jongminm/sparse_kmeans/experiment/28_07_30_2025/bandit_spectral/bandit_spectral_sep4_p16000_rep_71.out"              # Standard output and error log file
...
echo "Starting job for p=16000, rep=71 on $(hostname) at $(date)"
...
matlab -batch "bandit_spectral_sep4_p16000_rep_71"

# Echo end time for logging
echo "Finished job for p=16000, rep=71 at $(date)"
