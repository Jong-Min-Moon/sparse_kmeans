#!/bin/bash
#SBATCH --job-name=bandit_p14000_rep31 # Job name for easier identification in queue
#SBATCH --output="/home1/jongminm/sparse_kmeans/experiment/28_07_30_2025/bandit_spectral/bandit_spectral_sep4_p14000_rep_31.out"              # Standard output and error log file
...
echo "Starting job for p=14000, rep=31 on $(hostname) at $(date)"
...
matlab -batch "bandit_spectral_sep4_p14000_rep_31"

# Echo end time for logging
echo "Finished job for p=14000, rep=31 at $(date)"
