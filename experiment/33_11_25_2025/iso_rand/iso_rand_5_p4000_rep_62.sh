#!/bin/bash
#SBATCH --job-name=iso_rand_p4000_rep62 # Job name for easier identification in queue
#SBATCH --output="/home1/jongminm/sparse_kmeans/experiment/33_11_25_2025/iso_rand/iso_rand_5_p4000_rep_62.out"              # Standard output and error log file
...
matlab -batch "iso_rand_5_p4000_rep_62"
