#!/bin/bash
#SBATCH --job-name=iso_rand_p2000_rep121 # Job name for easier identification in queue
#SBATCH --output="/home1/jongminm/sparse_kmeans/experiment/33_11_25_2025/iso_rand/iso_rand_5_p2000_rep_121.out"              # Standard output and error log file
...
matlab -batch "iso_rand_5_p2000_rep_121"
