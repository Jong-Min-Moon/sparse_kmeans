#!/bin/bash
#SBATCH --job-name=iso_rand_p1000_rep180 # Job name for easier identification in queue
#SBATCH --output="/home1/jongminm/sparse_kmeans/experiment/33_11_25_2025/iso_rand/iso_rand_4_p1000_rep_180.out"              # Standard output and error log file
...
cd "/home1/jongminm/sparse_kmeans/experiment/33_11_25_2025/iso_rand" || { echo "Error: Could not change to directory /home1/jongminm/sparse_kmeans/experiment/33_11_25_2025/iso_rand. Exiting."; exit 1; }

# Run the MATLAB script in batch mode
# The -batch option runs the specified script and then exits MATLAB
matlab -batch "iso_rand_4_p1000_rep_180"
