#!/bin/bash
#SBATCH --job-name=iso_rand_p1000_rep124 # Job name for easier identification in queue
#SBATCH --output="/home1/jongminm/sparse_kmeans/experiment/33_11_25_2025/iso_rand/iso_rand_4_p1000_rep_124.out"              # Standard output and error log file
...
matlab -batch "iso_rand_4_p1000_rep_124"
