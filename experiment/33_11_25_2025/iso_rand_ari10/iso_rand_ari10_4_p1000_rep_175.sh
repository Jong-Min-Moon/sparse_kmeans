#!/bin/bash
#SBATCH --job-name=iso_rand_ari10_p1000_rep175 # Job name for easier identification in queue
#SBATCH --output="/home1/jongminm/sparse_kmeans/experiment/33_11_25_2025/iso_rand_ari10/iso_rand_ari10_4_p1000_rep_175.out"              # Standard output and error log file
...
matlab -batch "iso_rand_ari10_4_p1000_rep_175"
