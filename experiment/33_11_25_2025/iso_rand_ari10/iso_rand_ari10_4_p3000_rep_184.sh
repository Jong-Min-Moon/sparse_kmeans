#!/bin/bash
#SBATCH --job-name=iso_rand_ari10_p3000_rep184 # Job name for easier identification in queue
#SBATCH --output="/home1/jongminm/sparse_kmeans/experiment/33_11_25_2025/iso_rand_ari10/iso_rand_ari10_4_p3000_rep_184.out"              # Standard output and error log file
...
matlab -batch "iso_rand_ari10_4_p3000_rep_184"
