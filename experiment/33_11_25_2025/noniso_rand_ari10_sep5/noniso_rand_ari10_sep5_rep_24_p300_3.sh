#!/bin/bash
#SBATCH --output="/home1/jongminm/sparse_kmeans/experiment/33_11_25_2025/noniso_rand_ari10_sep5/noniso_rand_ari10_sep5_rep_24_p300_3.out"
...
matlab -batch noniso_rand_ari10_sep5_rep_24_p300_3
