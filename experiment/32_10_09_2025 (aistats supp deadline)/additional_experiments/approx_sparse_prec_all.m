...
job_folder = fullfile('/home1/xxx/.matlab/local_cluster_jobs/R2022a', getenv('SLURM_JOB_ID'));
...
table_name = 'approx_sparse_prec_001';
db_dir = '.db'; % your own sqlite3 db file

% Data generation
cluster_1_ratio = 0.5;
% Note: Semicolon added to suppress output
generator = data_generator_approximately_sparse_precision2(n, p, s, sep, rep, 0.5);
