...
for jj = 1:1
    ...
    data = table(...
        ...
        repelem(s, n_iter+1)',...
        acc_vec,...
        [0; iterative_kmeans_learner.obj_val_prim],...
        [0; iterative_kmeans_learner.obj_val_dual],...
        [0; discov_true_vec],...
        [0; discov_false_vec],...
        [""; survived_indices],...
        [0; diff_x_tilde_fro],...
        [0; diff_x_tilde_op],...
        [0; diff_x_tilde_ellone],...
        [0; iterative_kmeans_learner.omega_est_time],...
        [0; iterative_kmeans_learner.sdp_solve_time], repelem(dt, n_iter+1)', ...
        'VariableNames', ...
        ["rep", "iter", "sep", "dim", "rho", "sparsity", "acc", "obj_prim", "obj_dual", "discov_true", "discov_false", "survived_indices", "diff_x_tilde_fro", "diff_x_tilde_op", "diff_x_tilde_ellone","precision_est_time", "time_SDP", "jobdate"])
