...
for jj = 1:1
    ...
    [cluster_est_mat, diff_x_tilde, entries_survived, omega_est_time, sdp_solve_time, obj_prim, obj_dual]= iterative_kmeans_ISEE_clean(x_noisy, K, n_iter, Omega, Omega_sparsity, 'spec');
    ...
    data = table(...
        ...
        ["rep", "iter", "sep", "dim", "rho", "sparsity", "acc", "obj_prim", "obj_dual", "discov_true", "discov_false", "diff_x_tilde"  "time_isee", "time_SDP", "jobdate"])
