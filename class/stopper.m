classdef stopper < handle
    ...
    methods
        function stop_decision = determine_stop(sp, obj_val_original, obj_val_prim, iter)
            if iter==1
                stop_decision = false;
            else
        ...
        function stop_decision = detect_relative_change_original(sp, obj_val_original, iter, percent_change)
