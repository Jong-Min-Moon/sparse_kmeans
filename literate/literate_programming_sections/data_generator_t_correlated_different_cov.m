classdef data_generator_t_correlated_different_cov < data_generator_t_correlated
%% data_generator_correlated_different_cov
% @export
 
    methods
    
        function obj = data_generator_t_correlated_different_cov(n, p, s, sep, seed, cluster_1_ratio)
